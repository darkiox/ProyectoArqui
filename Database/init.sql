...
INSERT INTO sales(id, sku, cantidad , valor, valortotal, fecha) VALUES (2, 2, 2, 1000, 2000,'2022-11-8');); 
INSERT INTO sales(id, sku, cantidad , valor, valortotal, fecha) VALUES (3, 5, 5, 800, 4000,'2022-8-10'););
INSERT INTO sales(id, sku, cantidad , valor, valortotal, fecha) VALUES (4, 4, 8, 200, 4000,'2022-10-18'););
INSERT INTO sales(id, sku, cantidad , valor, valortotal, fecha) VALUES (5, 5, 7, 600, 4200,'2022-12-8'););
INSERT INTO sales(id, sku, cantidad , valor, valortotal, fecha) VALUES (6, 6, 1, 500, 500,'2022-12-3'););
INSERT INTO sales(id, sku, cantidad , valor, valortotal, fecha) VALUES (7, 8, 1, 300, 300,'2022-11-30'););
INSERT INTO sales(id, sku, cantidad , valor, valortotal, fecha) VALUES (8, 9, 2, 150000, 300000,'2022-2-25'););
INSERT INTO sales(id, sku, cantidad , valor, valortotal, fecha) VALUES (9, 1, 6, 50000, 300000,'2022-10-8'););
INSERT INTO purchases(id, sku, cantidad , valor, valortotal, fecha) VALUES (1, 1, 10, 10000, 100000,'2022-12-11');
INSERT INTO purchases(id, sku, cantidad , valor, valortotal, fecha) VALUES (2, 2, 20, 1000, 200000,'2022-11-8');); 
INSERT INTO purchases(id, sku, cantidad , valor, valortotal, fecha) VALUES (3, 5, 30, 800, 24000,'2022-8-10'););
INSERT INTO purchases(id, sku, cantidad , valor, valortotal, fecha) VALUES (4, 4, 100, 200, 20000,'2022-10-18'););
INSERT INTO purchases(id, sku, cantidad , valor, valortotal, fecha) VALUES (5, 5, 90, 600, 54000,'2022-12-8'););
INSERT INTO purchases(id, sku, cantidad , valor, valortotal, fecha) VALUES (6, 6, 70, 500, 35000,'2022-12-3'););
INSERT INTO purchases(id, sku, cantidad , valor, valortotal, fecha) VALUES (7, 8, 9, 300, 2700,'2022-11-30'););
INSERT INTO purchases(id, sku, cantidad , valor, valortotal, fecha) VALUES (8, 9, 10, 150000, 1500000,'2022-2-25'););
INSERT INTO purchases(id, sku, cantidad , valor, valortotal, fecha) VALUES (9, 1, 12, 50000, 600000,'2022-10-8'););
